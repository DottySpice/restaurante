...
<div class="modal fade" id="editarUsuario<?php echo $usuario["id_usuario"]; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content " >
            ...
            <?php $accion="update"; ?> 
            <form class="p-1"  action="perfil.php?accion=<?php echo $accion;?>&id=<?php echo $usuario["id_usuario"];?>&id_persona=<?php echo $usuario["id_persona"];?>" method="POST" enctype="multipart/form-data">
                <div class="modal-body text-green"> 
                    <div class="text-green">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="email"  value="<?php echo $usuario["correo"];?>" class="form-control" placeholder="Correo" <?php if($usuario["id_rol"] == 2){echo "disabled";} ?>>
                        </div> 
                        <div class="input-group mb-3">
                            <span class="input-group-text text-green" id="basic-addon1"><i class="fa-solid fa-key"></i></span>
                            <input type="password" value="<?php echo $usuario["contrasena"];?>"  class="form-control" placeholder="Contrasena" <?php if($usuario["id_rol"] == 2){echo "disabled";} ?>>
                        </div>           
                    </div>
                    <hr>
                    <div class="text-green">
